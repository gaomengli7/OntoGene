...
class OntoGeneTrainerDeepSpeedConfig(HfTrainerDeepSpeedConfig):

    def trainer_config_process(self, args):
        train_gene_seq_batch_size = args.world_size * args.per_device_train_gene_seq_batch_size * args.gradient_accumulation_steps
        train_gene_go_batch_size = args.world_size * args.per_device_train_gene_go_batch_size * args.gradient_accumulation_steps
        train_go_go_batch_size = args.world_size * args.per_device_train_go_go_batch_size * args.gradient_accumulation_steps

        self.fill_match(
            "train_micro_gene_seq_batch_size_per_gpu", args.per_device_train_gene_seq_batch_size, "per_device_train_gene_seq_batch_size"
        )
        self.fill_match(
            "train_micro_gene_go_batch_size_per_gpu", args.per_device_train_gene_go_batch_size, "per_device_train_gene_go_batch_size"
        )
        self.fill_match(
        ...
        self.fill_match("train_gene_seq_batch_size", train_gene_seq_batch_size, "train_gene_seq_batch_size (calculated)")
        self.fill_match("train_gene_go_batch_size", train_gene_go_batch_size, "train_gene_go_batch_size (calculated)")
